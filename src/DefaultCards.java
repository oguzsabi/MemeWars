...
public class DefaultCards {
    ...
    private Card trollFace = new Card("Troll Face", 6 ,4,3,"DR", false,false,true,true,  new ArrayList<>(Arrays.asList("SpawnMinion",2,2,2)));
    private Card lambSauce = new Card("Lamb Sauce", 4 ,2,3,"DR", false,false,true,true,  new ArrayList<>(Arrays.asList("SpawnMinion",2,2,2)));
    private Card frodo = new Card("Frodo", 4 ,2,3,"DR", false,false,true,true,  new ArrayList<>(Arrays.asList("DamageRandomTarget",1,3)));
    private Card snape = new Card("Snape", 4 ,2,3,"DR", false,false,true,true,  new ArrayList<>(Arrays.asList("DamageRandomTargets",1,3)));
}
